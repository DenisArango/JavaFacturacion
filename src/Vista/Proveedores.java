...
public class Proveedores extends javax.swing.JFrame {
    ...
    private void btnGuardarCambiosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarCambiosActionPerformed
        ...
        if(prov.getId_prov() == 0){
            if(prov.agregarProveedor(empresa, direccion, ciudad, pais, telefono, nit, email) == 0){
                ...
                JOptionPane.showMessageDialog(null, "Fallo al intentar agregar el registro");
            }
        }else{
            if(prov.actualizarProveedor(prov.getId_prov(), empresa, direccion, ciudad, pais, telefono, nit, email) == 0){
                ...
                JOptionPane.showMessageDialog(null, "Fallo al intentar actualizar el registro");
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        if(prov.getId_prov() == 0){
            JOptionPane.showMessageDialog(null, "Ningun registro seleccionado para eliminar");
        }else{
            ...
            if(confirmar == JOptionPane.YES_OPTION){
                if(prov.eliminarProveedor(prov.getId_prov()) == 0){
                    ...
                    JOptionPane.showMessageDialog(null, "Fallo al intentar eliminar el registro");
                }
            }
        }
